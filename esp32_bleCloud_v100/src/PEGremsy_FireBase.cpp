...
/** @group FIREBASE_INIT
    @{
*/#ifndef FIREBASE_INIT
#define FIREBASE_INIT
/** @brief Firebase Init
    @return none
*/
void PEGremsy_FireBase_t::init(void)
{
...
/** @brief Firebase ready
    @return none
*/
bool PEGremsy_FireBase_t::fireBaseReady(void)
{
    bool ret = false;

    if(Firebase.ready() == true) ret = true;
    
    return ret;
}

/** @brief Firebase process
    @return none
*/
void PEGremsy_FireBase_t::process(void)
{
    if (Firebase.ready() && (millis() - dataMillis > 30000 || dataMillis == 0))
    {
        ...
        //array
        content.set("fields/myArray/arrayValue/values/[0]/stringValue", "nguyenvankinh12");
